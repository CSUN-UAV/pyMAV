...
#"""
    ...
    print ("Taking off!")
    vehicle.simple_takeoff(0.5)  # Take off to target altitude in this case i want half a meter lol
...
#         if vehicle.location.global_relative_frame.alt < 2:
#             set_velocity_body(vehicle,0,0,0.1)
        #once it lands i want it to go back up and hover so we need to reconnect the vehicle or drone
       # print ('Connecting to vehicle on: %s' % connection_string)
...
############# POINTS ###############
# p1 = LocationGlobalRelative(24.830125, 67.097387, 0.5)


############# TAKE OFF #############
arm_and_takeoff(0.5)                                                                                                 # Vehicle takeoff
...
############### LAND ################
# temp_land()
# ############## RECONNECT SO I CAN FLY AGAIN AND CALL THE TAKEOFF FUNCTION#####
# print ('Connecting to vehicle on: %s' % connection_string)
